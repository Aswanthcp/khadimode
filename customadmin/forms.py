...
class CategoryEditForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['discription'].widget.attrs.update(
            {'class': 'form-control'})
...
class ItemCreateForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['descrbtion'].widget.attrs.update(
            {'class': 'form-control'})
...
class VariationForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['variation_category'].widget.attrs.update(
            {'class': 'form-control'})
        self.fields['variation_value'].widget.attrs.update(
            {'class': 'form-control'})
...
class DiscountCouponForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['coupon_name'].widget.attrs.update(
            {'class': 'form-control'})
        self.fields['coupon_min'].widget.attrs.update(
            {'class': 'form-control'})
        self.fields['coupon_start'].widget.attrs.update(
            {'class': 'form-control'})
        self.fields['coupon_end'].widget.attrs.update(
            {'class': 'form-control'})

        self.fields['coupon_code'].widget.attrs.update(
            {'class': 'form-control'})
        self.fields['coupon_offer'].widget.attrs.update(
            {'class': 'form-control'})
        self.fields['coupon_start'].widget.attrs.update(
            {'class': 'form-control'})
